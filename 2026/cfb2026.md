...
# Model Counting Competition 2026 (Call for Benchmarks)
...
The 5th International Competition on Model Counting (MC 20256)

- [http://mccompetition.org/2026/mc_description](http://mccompetition.org/2025/mc_description)

The Model Counting Competition MC 2026 invites submission of collections of counting instances
in formats as given at the competition tracks.

## Setting

*Model counting* is a vibrant field that provides recent advances in theory and
...
From existing and submitted benchmarks, we will select instances on which we evaluate submissions in MC2025.
Instances and mappings will be publicly released on Zenodo.

## Submission

Before April 18, 2026, contributors of benchmarks are expected to

- Register for benchmark submission at [https://tinyurl.com/benchmarks-mc26](https://tinyurl.com/benchmarks-mc25), and decide between
    - (A) providing us with a link to download the instances (including description) or
...
- We appreciate if the submissions contain in addition the following information:
  ...
  – a file (counts.txt) listing the known counts, the expected hardness, and if applicable in
...
We expect that results will be presented at the [SAT 2026 conference](http://satisfiability.org/SAT25/).
