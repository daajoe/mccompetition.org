...
All tracks will be run on tbd.
<!--
the [BenchCloud Instance of SoSy Lab in Munich](https://benchcloud.sosy-lab.org/) 
using compute nodes with an 8 cores Intel Xeon E3-1230 v5 @ 3.40 GHz CPU. 
-->
The solvers will be executed with a time limit of 3600 seconds and memory limit of 32GB.
